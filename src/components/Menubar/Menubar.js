        ...
        <div class="navbar bg-base-100 w-11/12 mx-auto">
            ...
            <div class="navbar-end gap-3">
                ...
                <div class="dropdown dropdown-end">
                    <label tabindex="0" class="btn btn-ghost btn-circle">
                        ...
                        <div className='border-2 border-violet-900 rounded-full p-1'>
                            <div class="indicator">
                                ...
                                <span class="indicator-item">4</span>
                            </div>
                        </div>
                    ...
                    <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div class="card-body bg-secondary">
                            <span class="text-info">message 1</span>
                            <span class="text-info">message 2</span>
                            <span class="text-info">message 3</span>
                            <span class="text-info">message 4</span>
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div class="card-body bg-secondary">
                            ...
                            <span class="text-info">Notification 2</span>
                            <span class="text-info">Notification 3</span>
                            <span class="text-info">Notification 4</span>
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 bg-secondary">
                        <li>Profile</li>
                        <li>Settings</li>
                        <li>Logout</li>
                    </ul>
